...
- [Compile](https://github.com/matter-labs/foundry-zksync#compile-with-zkforge-zk-build)
- [Deploy](https://github.com/matter-labs/foundry-zksync#deploy-with-zkforge-zk-create)
- [Bridge assets](https://github.com/matter-labs/foundry-zksync#bridge-assets-l1--l2-with-zkcast-zk-send-and-zkcast-zk-deposit)
- [Interact with contract](https://github.com/matter-labs/foundry-zksync#interact-with-contract-with-zkcast-zk-send)

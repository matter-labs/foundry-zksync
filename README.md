...
- **Windows Compatibility**: Windows is not officially supported yet. However, we will be adding support for Windows soon and will assist with reported issues as possible. 

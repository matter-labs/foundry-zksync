...
impl FuzzedExecutor {
    ...
    pub fn fuzz(
        ...
        // NOTE(zk): Upstream refactored to parallel fuzzing. Strategy creation (including
        // no_zksync_reserved_addresses) moved from here to run_worker() for per-worker instances.
    ...
    fn run_worker(
        ...
        let no_zksync_reserved_addresses =
            shared_state.state.dictionary_read().no_zksync_reserved_addresses();

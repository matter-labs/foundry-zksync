...
use foundry_evm_core::backend::strategy::BackendStrategy;
...
pub fn replay_run<B: BackendStrategy>(
...
#[allow(clippy::too_many_arguments)]
pub fn replay_error<B: BackendStrategy>(
...
fn set_up_inner_replay<B: BackendStrategy>(executor: &mut Executor<B>, inner_sequence: &[Option<BasicTxDetails>]) {

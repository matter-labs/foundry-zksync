...
contract ZkCheatcodesTest is Test {
    ...
    function testZkCheatcodesEtch() public {
        ...
        string memory artifact = vm.readFile("./zkout/ConstantNumber.sol/ConstantNumber.json");
    ...
    /// See: https://getfoundry.sh/reference/cheatcodes/expect-revert
    ...
    function getCodeCheck(string memory contractName, string memory outDir) internal {
        ...
        string memory artifactPath = string.concat(outDir, "/", contractName, ".sol/", contractName, ".json");
...
contract ZkCheatcodesInZkVmTest is Test {
...
contract EvmTargetContract is Test {
